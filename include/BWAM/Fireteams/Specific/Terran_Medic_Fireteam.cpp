...
void Terran_Medic_Fireteam::deploy(BWAPI::Position pos) {
...
void Terran_Medic_Fireteam::assist(Fireteam* toAssist) { // Should be conditional on coreType and toAssist.getUnitType()
...
void Terran_Medic_Fireteam::updateMicro() 
{
